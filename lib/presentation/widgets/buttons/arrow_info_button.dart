...
class ArrowInfoButton extends StatefulWidget {
  final String title;
  ...
  @override
  _ArrowInfoButtonState createState() => _ArrowInfoButtonState();
}

class _ArrowInfoButtonState extends State<ArrowInfoButton> {
