              ...
              child: Column(
                ...
                children: [
                  ...
                  hasTitle2
                      ? Text(
                          title2,
                          style: (title2Style ?? titleStyle)?.copyWith(color: AppColors.primaryColor),
                        )
                      : Empty(),
                  SpaceH20(),
                  Text(
                    body,
                    style: textTheme.bodyText1?.copyWith(fontSize: fontSize, height: 1.8),
                  ),
          ...
          children: [
            ...
            Text(
              ...
              style: textTheme.bodyText2?.copyWith(
                fontSize: fontSize,
                fontWeight: FontWeight.w400,
                color: config.darkThemeEnabled ? AppColors.grey100 : AppColors.grey250,
              ),
            ),
          ],
        ),
