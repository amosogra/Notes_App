...
import 'package:notes_app/presentation/widgets/buttons/arrow_info_button.dart';
import 'package:notes_app/presentation/widgets/buttons/nimbus_button.dart';
import 'package:notes_app/presentation/widgets/buttons/social_button_2.dart';
...
class _AboutMeSectionState extends State<AboutMeSection> with TickerProviderStateMixin {
  ...
  List<Widget> _buildArrowInfoButtons() {
    List<Widget> items = [
      ArrowInfoButton(
        title: StringConst.ANB_TEXT_1,
        iconData: Icons.arrow_forward_ios,
        leadingButtonColor: AppColors.primaryColor,
        //onTap: widget.onPressed,
      ),
      ArrowInfoButton(
        title: StringConst.ANB_TEXT_2,
        iconData: Icons.arrow_forward_ios,
        leadingButtonColor: AppColors.primaryColor,
        //onTap: widget.onPressed,
      ),
      ArrowInfoButton(
        title: StringConst.ANB_TEXT_3,
        iconData: Icons.arrow_forward_ios,
        leadingButtonColor: AppColors.primaryColor,
        //onTap: widget.onPressed,
      ),
      ArrowInfoButton(
        title: StringConst.ANB_TEXT_4,
        iconData: Icons.arrow_forward_ios,
        leadingButtonColor: AppColors.primaryColor,
        //onTap: widget.onPressed,
      ),
      ...
      Text.rich(
        TextSpan(
          children: [
            TextSpan(text: StringConst.ANB_TEXT_POINTS_1),
            TextSpan(text: StringConst.ANB_TEXT_POINTS_2),
            TextSpan(text: StringConst.ANB_TEXT_POINTS_3),
            TextSpan(text: StringConst.ANB_TEXT_POINTS_4),
          ],
        ),
      ),
      NimbusButton(
          ...
          child: Column(
            ...
            children: [
              NimbusInfoSection1(
                ...
                title1: StringConst.EMPOWERMENT_INITIATIVE,
