...
import 'package:notes_app/presentation/widgets/skill_card.dart';
import 'package:notes_app/presentation/widgets/skill_level.dart';
    ...
    return Container(
      ...
      child: ResponsiveBuilder(
        ...
        builder: (context, sizingInformation) {
          ...
          } else if (screenWidth > RefinedBreakpoints().tabletSmall && screenWidth <= 1024) {
            return VisibilityDetector(
