...
class ScrollBarDelegate extends SliverPersistentHeaderDelegate {
  ScrollBarDelegate(this.builder, {this.minHeight: kToolbarHeight, this.maxHeight: kToolbarHeight, this.backgroundColor});
...
class ScrollPageBarDelegate extends ScrollBarDelegate {
  ScrollPageBarDelegate(this.builder, {this.minHeight, this.maxHeight, this.backgroundColor}) : super(null);
  final double? minHeight;
  final double? maxHeight;
  final Color? backgroundColor;
  final Function builder;
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    return Container(
        ...
        child: new SizedBox.expand(child: builder(context, shrinkOffset, overlapsContent, shrink, stretch)));
  }
}
...
class ScrollPageBarDelegateTmp extends SliverPersistentHeaderDelegate {
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    //   // log('stretch $stretch shrink $shrink');
    // });
