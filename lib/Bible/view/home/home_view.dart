...
class HomeView extends _State with _Bar, _Refresh, _Info {
          ...
          body: SafeArea(
            child: frl.ReorderableList(
              ...
              decoratePlaceholder: (Widget item, double opacity) {
                return frl.DecoratedPlaceholder(widget: item, offset: opacity);
              },
              child: _reorder(),
            ),
          )),
  ...
  Widget booksItemWidget(CollectionBible collectionBible) {
    ...
    return frl.ReorderableItem(
      key: ValueKey<String?>(collectionBible.identify),
      childBuilder: (BuildContext context, frl.ReorderableItemState state) {
                ...
                subtitle: Row(
                  ...
                  children: <Widget>[
                    Container(
                        ...
                        child: Text(collectionBible.language!.name!.toUpperCase(),
                    ...
                    Text(collectionBible.shortname!,
                        style: Theme.of(context).textTheme.subtitle2!.copyWith(fontSize: 15, height: collectionBible.language!.name == 'my' ? 1.5 : 1.0))
                  ],
                ),
                trailing:
                    Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
