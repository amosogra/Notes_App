...
class ReadView extends _State with _Bar, _Gesture {
  @override
  ...
  Widget get _loadChapter {
    ...
    return FutureBuilder<bool>(future: getResult, builder: (BuildContext context, AsyncSnapshot<bool> snapshot) => _loadChapterBuilder(snapshot));
  }
