...
import 'package:notes_app/utils/log.dart' as xlog;
...
class MainRead extends StatefulWidget {
  MainRead({Key? key}) : super(key: key);
  @override
  ReadView createState() => new ReadView();
}

abstract class _State extends State<MainRead> with TickerProviderStateMixin {
  ...
  verseSelection(int? id) {
    // log('selectVerse from it parent $id');
