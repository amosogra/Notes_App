...
mixin _Bar on _State {
  Widget sliverPersistentHeader() {
    return new SliverPersistentHeader(floating: true, pinned: true, delegate: new ScrollPageBarDelegate(bar, minHeight: 30)
  ...
  Widget bar(BuildContext context, double offset, bool overlaps, double stretch, double shrink) {
    ...
    // log('overlaps $overlaps stretch $stretch shrink $shrink');
      ...
      Align(
        ...
        child: Tooltip(
          ...
          child: CupertinoButton(
            ...
            minSize: 30,
            child: Icon(CustomIcon.bookmark, color: hasBookmark ? Colors.red : Colors.grey[350]?.withOpacity(0.7), size: (25 * stretch).clamp(15, 25).toDouble()),
              ...
              children: <Widget>[
                AnimatedContainer(
                  ...
                  child: Tooltip(
                    ...
                    child: CupertinoButton(
                      color: (stretch <= 0.5) ? null : (Theme.of(context).brightness == Brightness.dark ? Colors.grey[700] : Colors.grey[200])?.withOpacity(stretch),
                      // minSize: 33,
                ...
                Container(alignment: Alignment.centerRight, width: 1, child: Opacity(opacity: shrink, child: Text(',', style: TextStyle(color: Colors.grey)))),
                // CupertinoButton(
                ...
                AnimatedContainer(
                    ...
                    child: Tooltip(
                      ...
                      child: CupertinoButton(
                          color:
                              (stretch <= 0.5) ? null : (Theme.of(context).brightness == Brightness.dark ? Colors.grey[700] : Colors.grey[200])!.withOpacity(stretch),
                          minSize: (33 * stretch).clamp(25.0, 33.0),
                          padding: EdgeInsets.symmetric(horizontal: 15 * stretch),
      ...
      Align(
          ...
          child: Tooltip(
            ...
            child: CupertinoButton(
                ...
                // ),
                child: Icon(CustomIcon.text_size, color: Colors.grey, size: (25 * stretch).clamp(15, 25).toDouble()),
                // child: Text('Aa'),
