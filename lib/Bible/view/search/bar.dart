...
mixin _Bar on _State {
  Widget sliverPersistentHeader() {
    return new SliverPersistentHeader(pinned: true, floating: true, delegate: new ScrollPageBarDelegate(_bar, minHeight: 40, maxHeight: 50));
  }
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: Opacity(
            ...
            child: SizedBox.shrink(
                ...
                child: (focusNode.hasFocus && this.textController.text.isNotEmpty)
                    ? new CupertinoButton(
                        onPressed: inputClear,
                        // color: Colors.orange,
                        padding: EdgeInsets.zero,
                        // child:Icon(Icons.clear,color:Colors.grey,size: 17),
                        child: Icon(CustomIcon.cancel, color: Theme.of(context).brightness == Brightness.dark ? Colors.white70 : Colors.grey[700], size: 12),
                      )
                    : null
        ...
        fillColor: Colors.grey[focusNode.hasFocus
