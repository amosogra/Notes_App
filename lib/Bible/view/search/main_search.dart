...
abstract class _State extends State<MainSearch> with TickerProviderStateMixin {
  ...
  bool get hasNotResult => core.scripturePrimary!
      .verseSearchDataIsEmpty(id: core.primaryId, testament: core.testamentId, book: core.bookId, chapter: core.chapterId, query: core.searchQuery);
