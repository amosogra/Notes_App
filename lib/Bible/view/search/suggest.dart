...
mixin _Suggest on _State {
  ...
  Widget _suggestionBook() {
    return new SliverList(
      ...
      return new Column(mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
        // Text(book.info.name),
        Container(
  ...
  Widget _suggestionKeywordBuilder(BuildContext context, CollectionKeyword keyword, int index) {
    return Dismissible(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: Theme.of(context).primaryColor, borderRadius: new BorderRadius.all(
              // Radius.elliptical(3, 3)
              Radius.elliptical(7, 100)), boxShadow: [
            BoxShadow(
              blurRadius: 0.0,
          ...
          child: new ListTile(
              ...
              title: RichText(
                  ...
                  text: TextSpan(
                      ...
                      children: <TextSpan>[TextSpan(text: keyword.word!.substring(searchQuery.length), style: TextStyle(color: Colors.black))])),
