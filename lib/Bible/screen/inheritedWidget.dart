...
class MainViewState extends State<MainView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Center(
        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
          FrogColor(
            ...
            child: Column(
                ...
                children: <Widget>[A(), C(), FlatButton(child: Text("withIn FrogColor ", style: TextStyle(color: Colors.red)), onPressed: () => setState(() {}))]),
          ),
          // A(),
          // C(),
...
class ValueNotifierInheritedWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // log(ValueNotifierInheritedModel.of(context).toString());
...
class A extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // log(context.visitAncestorElements((element) => false));
    // return  B();
    return Row(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
      Text("a", style: TextStyle(color: FrogColor.of(context)!.color)),
      Text(FrogColor.of(context)!.value ?? 'None'),
    ]);
  }
