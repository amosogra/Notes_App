...
import 'package:notes_app/Bible/view/home/main_home.dart' as Home;
import 'package:notes_app/Bible/view/read/main_read.dart' as Read;
import 'package:notes_app/Bible/view/note/main_note.dart' as Note;
import 'package:notes_app/Bible/view/search/main_search.dart' as Search;
// import 'package:notes_app/Bible/view/more/main.dart' as More;

import 'package:notes_app/Bible/screen/SplashScreen.dart';
...
class _MainState extends State<MainView> with TickerProviderStateMixin {
  ...
  final GlobalKey<Home.HomeView> home = GlobalKey<Home.HomeView>();
  final GlobalKey<Read.ReadView> read = GlobalKey<Read.ReadView>();
  final GlobalKey<Note.NoteView> note = GlobalKey<Note.NoteView>();
  final GlobalKey<Search.SearchView> search = GlobalKey<Search.SearchView>();
  ...
  void initState() {
    ...
    if (pageView.length == 0) {
      ...
      pageView = [
        WidgetKeepAlive(key: homeKey, child: new Home.MainHome(key: home, barMaxHeight: 120)),
        WidgetKeepAlive(key: readKey, child: new Read.MainRead(key: read)),
        WidgetKeepAlive(key: noteKey, child: new Note.MainNote(key: note)),
        WidgetKeepAlive(key: searchKey, child: new Search.MainSearch(key: search)),
