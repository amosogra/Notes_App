...
mixin _Utility {
  ...
  Future<void> analyticsShare(String contentType, String? itemId) async {
    await _analytics.logEvent(name: 'share', parameters: <String, dynamic>{'content_type': contentType, 'item_id': itemId});
  }

  Future<void> analyticsContent(String contentType, String? itemId) async {
    // log('analyticsContent contentType:$contentType itemId: $itemId');
    await _analytics.logEvent(name: 'select_content', parameters: <String, dynamic>{'content_type': contentType, 'item_id': itemId});
  }
  ...
  Future<void> analyticsScreen(String? name, String classes) async {
    ...
    // log('analyticsScreen $name $classes');
