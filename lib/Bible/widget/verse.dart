...
import 'package:notes_app/Bible/inherited.dart';
            ...
            child: SelectableText.rich(
                TextSpan(children: <TextSpan>[
                  TextSpan(
                      text: '\t',
                      children: <TextSpan>[
                        TextSpan(text: verse!.name, semanticsLabel: 'verse: ' + verse!.name!),
                      ],
                      style: TextStyle(color: Colors.grey, fontSize: userVerse.titleSize, fontWeight: FontWeight.w300)),
                  // TextSpan(text: '\t'),
                  ...
                  if (alsoInVerse != null && alsoInVerse!.isNotEmpty)
                    TextSpan(text: '\t ...' + alsoInVerse!, style: TextStyle(color: Colors.grey, fontSize: userVerse.titleSize, fontWeight: FontWeight.w300)
