...
class WidgetContent extends StatelessWidget {
  WidgetContent(
      {Key? key, this.startWith: '...', this.atLeast: 'enable at least\na ', this.enable: 'Bible', this.task: '\nto ', this.message: 'read', this.endWith: '...'})
      : super(key: key);
        ...
        child: RichText(
          ...
          text: TextSpan(
            ...
            children: <TextSpan>[
              ...
              TextSpan(
                text: this.message,
                style: TextStyle(color: Theme.of(context).brightness == Brightness.dark ? Colors.yellow : Colors.brown, fontSize: 25),
              ),
              TextSpan(
                text: this.endWith,
              )
