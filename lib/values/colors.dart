...
class AppColors {
  ...
  //Accent colors
  static const Color primaryText1Light = Color(0xFF959595);
  static const Color primaryText2Light = Color(0xFF717171);

  //Accent colors
  static const Color primaryText1Dark = grey100;
  static const Color primaryText2Dark = grey150;
